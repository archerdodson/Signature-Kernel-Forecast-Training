...
with torch.no_grad():
    ...
    string2 += f"\nAverage values area: Cal. error {cal_err_values_weighted.mean():.4f}, RMSE {rmse_values_weighted.mean():.4f}, R2 {r2_values_weighted.mean():.4f}, NCRPS {CRPS_values_weighted.mean():.4f}\n"
    string2 += f"\nStandard deviation: Cal. error {cal_err_values_weighted.std():.4f}, RMSE {rmse_values_weighted.std():.4f}, R2 {r2_values_weighted.std():.4f}, NCRPS {CRPS_values_weighted.std():.4f}\n\n"
